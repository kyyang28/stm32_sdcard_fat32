...
//	printf("sector[510]: 0x%x, %d\r\n", sector[510], __LINE__);
//	printf("sector[511]: 0x%x, %d\r\n", sector[511], __LINE__);
...
//		printf("%s, %d\r\n", __FUNCTION__, __LINE__);
	...
	printf("afatfs.fatStartSector: %u, %d\r\n", afatfs.fatStartSector, __LINE__);
...
//		printf("afatfs.filesystemState: %u, %s, %d\r\n", afatfs.filesystemState, __FUNCTION__, __LINE__);
